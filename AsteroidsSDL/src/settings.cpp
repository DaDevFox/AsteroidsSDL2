...
const float SHIP_warning_time = 20.0F;
const float SHIP_min_warning_focus_time = 10.0F; // min amount of time to dedicate to a new warning target (attention can't be stolen for __ seconds)
